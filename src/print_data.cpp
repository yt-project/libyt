...
int print_yt_param_yt(const yt_param_yt& param_yt) {
    ...
    if (param_yt.frontend != nullptr) log_debug("   %-*s = %s\n", width_scalar, "frontend", param_yt.frontend);
...
int print_yt_field(const yt_field& field) {
    ...
    log_debug("   %-*s = (%d, %d, %d, %d, %d, %d)\n", width_scalar + 2, "field_ghost_cell", field.field_ghost_cell[0],
              field.field_ghost_cell[1], field.field_ghost_cell[2], field.field_ghost_cell[3],
              field.field_ghost_cell[4], field.field_ghost_cell[5]);
