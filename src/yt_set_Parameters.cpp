...
int yt_set_Parameters(yt_param_yt* input_param_yt) {
    ...
    // strings
    python_controller::AddStringToDict(LibytProcessControl::Get().py_param_yt_, "frontend", param_yt.frontend);
    python_controller::AddStringToDict(LibytProcessControl::Get().py_param_yt_, "fig_basename", param_yt.fig_basename);

    // scalars
    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "current_time", param_yt.current_time);
    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "current_redshift",
                                       param_yt.current_redshift);
    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "omega_lambda", param_yt.omega_lambda);
    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "omega_matter", param_yt.omega_matter);
    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "hubble_constant",
                                       param_yt.hubble_constant);
    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "length_unit", param_yt.length_unit);
    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "mass_unit", param_yt.mass_unit);
    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "time_unit", param_yt.time_unit);
    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "velocity_unit",
                                       param_yt.velocity_unit);

    if (param_yt.magnetic_unit == DBL_UNDEFINED) {
        python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "magnetic_unit", 1);
    } else {
        python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "magnetic_unit",
                                           param_yt.magnetic_unit);
    }

    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "cosmological_simulation",
                                       param_yt.cosmological_simulation);
    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "dimensionality",
                                       param_yt.dimensionality);
    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "refine_by", param_yt.refine_by);
    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "index_offset", param_yt.index_offset);
    python_controller::AddScalarToDict(LibytProcessControl::Get().py_param_yt_, "num_grids", param_yt.num_grids);

    // vectors (stored as Python tuples)
    python_controller::AddVectorNToDict(LibytProcessControl::Get().py_param_yt_, "domain_left_edge", 3,
                                        param_yt.domain_left_edge);
    python_controller::AddVectorNToDict(LibytProcessControl::Get().py_param_yt_, "domain_right_edge", 3,
                                        param_yt.domain_right_edge);
    python_controller::AddVectorNToDict(LibytProcessControl::Get().py_param_yt_, "periodicity", 3,
                                        param_yt.periodicity);
    python_controller::AddVectorNToDict(LibytProcessControl::Get().py_param_yt_, "domain_dimensions", 3,
