...
//
// Notes       :  1  Allocating and freeing memories are manage by other function, this
// method only
//                   stores it.
//                2. This acts like a global.
//                3. This is helpful when there are other initialization processes added
//                to libyt.
//                   (What I'm doing in this commit is trying to make libyt a C-library
//                   with minimal
//                    change.)
//                4. This singleton implementation is _not_ thread-safe. I didn't make it
//                so, because
...
// Description :  Initialize libyt process control; every operation should happen after
// this step.
//
// Notes       :  1. It is called in yt_initialize().
//                2. Initialize MPI rank, MPI size for all other classes. (if not in
//                SERIAL_MODE)
