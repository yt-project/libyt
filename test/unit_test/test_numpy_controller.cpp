...
TEST_F(TestNumPyController,
       Can_create_numpy_array_from_existing_pointer_and_get_array_info) {
  // Arrange
  const int kNdim = 3;
  ...
  // Act
  PyObject* np_array =
      numpy_controller::ArrayToNumPyArray(3, dims, data_dtype, array, false, false);
