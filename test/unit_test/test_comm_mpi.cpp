...
TEST_F(TestBigMpi, BigMpiAllgatherv_can_pass_AmrDataArray3D) {
    ...
    // Act
    BigMpiStatus result =
        BigMpiAllgatherv<AmrDataArray3D>(send_count_in_each_rank, (void*)send_buffer, mpi_datatype, (void*)recv_buffer);
...
TEST_F(TestBigMpi, BigMpiAllgatherv_can_pass_MpiRmaAddress) {
    ...
    // Act
    BigMpiStatus result =
        BigMpiAllgatherv<MpiRmaAddress>(send_count_in_each_rank, (void*)send_buffer, mpi_datatype, (void*)recv_buffer);
