#ifndef LIBYT_PROJECT_INCLUDE_NEW_MAGIC_COMMAND_H_
#define LIBYT_PROJECT_INCLUDE_NEW_MAGIC_COMMAND_H_
...
public:
    explicit NewMagicCommand(EntryPoint entry_point) : output_(), entry_point_(entry_point), command_undefined_(true){};
    MagicCommandOutput& Run(const std::string& command = std::string(""));
};

#endif  // LIBYT_PROJECT_INCLUDE_NEW_MAGIC_COMMAND_H_
